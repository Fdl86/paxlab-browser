# PAXLAB Browser Engine - DEV15.28.1

DEV15.28.1 consolide la refonte UI premium avec alignement propre de la sidebar et optimisation CSS ciblee. La logique audio reste celle de DEV15.27.1 : moteur DSP, cibles LUFS, player A/B, exports WAV / FLAC, Basses punchy, Espace stereo et securites restent inchanges.
...
- Titre de l onglet navigateur passe en `PAXLAB Browser Engine - DEV15.28.1`.


### Correctifs et optimisation CSS DEV15.28.1
